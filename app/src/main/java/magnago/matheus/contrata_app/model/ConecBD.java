...
public class ConecBD {
    ...
    public boolean register(String newNome, String newEmail, String newCpf, String newPassword, String newProfissao) {
        ...
        httpRequest.addParam("nova_profissao", newProfissao);
